...
:*
:*                    Clase para consultar la fecha2 del activity
:*
:*  Archivo     : ConsultarFecha2Activity.java
...
:*  Descripción : Clase para consultar la fecha2 del activity
:*  Ultima modif:
...
//-------------------------------------------------------------------------------------------------
public class ConsultarFecha2Activity extends AppCompatActivity {
    ...
    private void eliminarAlumno() {
        ...
        db.delete(UtilidadesFecha.TABLA_MATERIA2, UtilidadesFecha.CAMPO_ID2 + "=?", parametros);
    ...
    private void actualizarAlumno() {
        ...
        values.put(UtilidadesFecha.CAMPO_NOMBRE2, campoNombre.getText().toString());
        values.put(UtilidadesFecha.CAMPO_STATUS2, campoStatus.getText().toString());


        db.update(UtilidadesFecha.TABLA_MATERIA2, values, UtilidadesFecha.CAMPO_ID2 + "=?", parametros);
    ...
    private void consultarSql() {
        ...
        try {
            ...
            Cursor cursor = db.rawQuery("SELECT " + UtilidadesFecha.CAMPO_STATUS2 + ", " + UtilidadesFecha.CAMPO_NOMBRE2 + " FROM " + UtilidadesFecha.TABLA_MATERIA2 +
                    " WHERE " + UtilidadesFecha.CAMPO_ID2 + "=? ", parametros);
