...
:*  Descripción : Clase que contiene los campos de nuestra tabla android y su sentencia para crear
                  la tabla
:*  Ultima modif:
...
public class Utilidades {
    ...
    //Constantes campos tabla android
    public static final String TABLA_MATERIA="android";
